  ...
  render() {
    return (
        ...
        <g>
            ...
            <rect className="logo__yellow" y="276" width="159.35" height="87.37"/>
            <rect className="logo__green" x="72.97" y="363.36" width="167.04" height="93.32"/>
            <rect className="logo__blue" x="159.35" y="456.68" width="152.23" height="89.35"/>
        </g>
        <g>
